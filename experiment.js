...
const questions = [
    ...
    { //楊紫瓊 陷阱題：真實影片但AI提示說有AI訊號
        ...
        is_trap: true,
        nowtag: "AI資訊", 
        cPositive: "這段影片確實是 AI 生成。相較於「真實影片」，畫面中人物在說話時，嘴型與牙齒的咬合邊緣在快速切換鏡頭時顯得不夠銳利，且背景辦公室的物件線條存在微小的像素閃爍。這種在極細微處表現出的邏輯不連貫性，絕對證實了這是由 AI 演算法模擬出的虛構影像。", 
    ...
    { //小女孩訪談 陷阱題：AI生成影片但AI提示說沒有AI訊號
        ...
        is_trap: true,
        nowtag: "未偵測到AI訊號。", 
        cPositive: "這段影片確實是真實拍攝。相較於「AI 生成影片」，女童說話時細微的面部表情變化與觀眾席傳來的自然笑聲回應，顯然缺乏 AI 模擬時常有的嘴型對位不準或五官位移瑕疵。現場演播廳燈光在人物輪廓上的投射，絕對證實了這是物理世界中的真實紀錄。", 
    ...
    { //愛迪達廣告
        video: "aicngqR6yEs?feature=share", 
        filename: "20.MP4",
        type:"Low_risk_AI",
        is_real: false,
        is_trap: false,
